...
class HMM2 {
    ...
    public HMM2(String[] state, double[][] amat,
    ...
    public static HMM2 baumwelch(String[] xs, String[] state,
        ...
        HMM2 hmm = new HMM2(state, amat, esym, emat);
        ...
        do {
            ...
            // Create new model
            hmm = new HMM2(state, amat, esym, emat);
