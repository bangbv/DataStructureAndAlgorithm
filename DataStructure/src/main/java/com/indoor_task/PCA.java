...
import com.Jama.EigenvalueDecomposition;
...
public class PCA {
    ...
    EigenvalueDecomposition edec; // eigenvalue decomposition (by com.Jama)
    ...
    public void centerData() {
        ...
        for (int i = 0; i < num_data; i++) {
            for (int j = 0; j < dim_data; j++) {
                ...
                System.out.printf(Locale.ENGLISH, "%+8.5f, ", data[i].v[j]);
            }
        ...
        for (int r = 0; r < dim_data; r++) { // rows
            for (int c = r; c < dim_data; c++) { // cols
                ...
                for (int i = 0; i < num_data; i++) {
                    ...
                    sum += data[r].v[i] * data[c].v[i];
                    //System.out.printf(Locale.ENGLISH, "%+8.5f, ", data[r].v[i]);
                    //System.out.printf(Locale.ENGLISH, "%+8.5f, ", data[c].v[i]);
                    //System.out.printf(Locale.ENGLISH, "%+8.5f, ", sum);
                }
                //System.out.println();
                mat[r][c] = mat[c][r] = sum / (num_data - 1);
                //System.out.printf(Locale.ENGLISH, "%+8.5f, ", mat[r][c]);
            }
            //System.out.printf(Locale.ENGLISH, "\n");
        }
        System.out.println();
